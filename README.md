# hmpps-accommodation-data-domain-api

[![Ministry of Justice Repository Compliance Badge](https://github-community.service.justice.gov.uk/repository-standards/api/hmpps-accommodation-data-domain-api/badge?style=flat)](https://github-community.service.justice.gov.uk/repository-standards/hmpps-accommodation-data-domain-api)
[![Docker Repository on ghcr](https://img.shields.io/badge/ghcr.io-repository-2496ED.svg?logo=docker)](https://ghcr.io/ministryofjustice/hmpps-accommodation-data-domain-api)
[![API docs](https://img.shields.io/badge/API_docs_-view-85EA2D.svg?logo=swagger)](https://accommodation-data-domain-api-dev.hmpps.service.justice.gov.uk/swagger-ui/index.html)
...
Our security policy is located [here](https://github.com/ministryofjustice/hmpps-accommodation-data-domain-api/security/policy).
...
## Renaming from HMPPS Accommodation Data Domain Api - github Actions
...
```bash
docker compose pull && docker compose up --scale hmpps-accommodation-data-domain-api=0
```
